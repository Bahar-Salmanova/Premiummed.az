        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo1 = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Photo2 = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Photo3 = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Desc = table.Column<string>(type: "nvarchar(240)", maxLength: 240, nullable: true),
                    FullDesc = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Desc = table.Column<string>(type: "nvarchar(240)", maxLength: 240, nullable: true),
                    FullDecs = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo1 = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Photo2 = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Photo3 = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ProductAbout = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ProductLink = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    File = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VacancyForms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VacancyForms_Vacancies_VacancyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VacancyForms_VacancyId",
                table: "VacancyForms",
                column: "VacancyId");
        }
