...
namespace PremiumMedStore.Areas.Admin.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,About,Desc,FullDecs")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,About,Desc,FullDecs")] News news)
        {
            if (id != news.Id)
            {
                return NotFound();
